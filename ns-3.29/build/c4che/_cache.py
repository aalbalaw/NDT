...
DEFINES = ['NS3_BUILD_PROFILE_DEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1', 'HAVE_GSL=1', 'HAVE_CRYPTO=1']
DEFINES_PYEMBED = ['_FORTIFY_SOURCE=2', 'NDEBUG']
DEFINES_PYEXT = ['_FORTIFY_SOURCE=2', 'NDEBUG']
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_SIGNAL_H': '', 'HAVE_SYS_TYPES_H': '', 'PYTHONDIR': '', 'INT64X64_USE_128': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': '', 'HAVE_SQLITE3': '', 'HAVE_LIBXML2': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PYEXT': '', 'HAVE_CRYPTO': '', 'HAVE_GSL': '', 'HAVE_SYS_STAT_H': '', 'HAVE_PACKET_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'HAVE_PYTHON_H': '', 'HAVE___UINT128_T': '', 'HAVE_PYEMBED': '', 'PYTHONARCHDIR': '', 'HAVE_GETENV': '', 'HAVE_RT': '', 'HAVE_IF_TUN_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['udp-client-server', 'tutorial', 'naming', 'socket', 'matrix-topology', 'ipv6', 'tcp', 'traffic-control', 'wireless', 'stats', 'energy', 'routing', 'realtime', 'udp', 'error-model']
...
NS3_EXECUTABLE_PATH = ['/home/az/NDT (SIGCOMM)/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/az/NDT (SIGCOMM)/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.9', '/home/az/NDT (SIGCOMM)/ns-allinone-3.29/ns-3.29/build/lib']
...
VALGRIND_FOUND = True
VERSION = '3.29'
WITH_PYBINDGEN = '/home/az/NDT (SIGCOMM)/ns-allinone-3.29/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/az/NDT (SIGCOMM)/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/az/NDT (SIGCOMM)/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_SYS_IOCTL_H', 'HAVE_IF_NETS_H', 'HAVE_NET_ETHERNET_H', 'HAVE_IF_TUN_H', 'HAVE_PACKET_H', 'HAVE_SQLITE3', 'HAVE_GSL', 'HAVE_CRYPTO']
