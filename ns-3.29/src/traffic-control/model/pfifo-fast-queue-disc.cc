...
//  	  NS_LOG_INFO("Packet seq#: "<<itpHdr.GetSeqNumber());
//  	  if(itpHdr.GetType()==3){
//  		  NS_LOG_INFO("Dropping data packet "<<itpHdr.GetSeqNumber());
//  	  }else{
//  		  NS_LOG_INFO("Dropping Interest "<<itpHdr.GetSeqNumber());
//  	  }
//
//  	  p->AddHeader(itpHdr);
//  	  p->AddHeader(udpHdr);
  if (GetCurrentSize () >= GetMaxSize ())
    {
      ...
      NS_LOG_INFO ("Queue disc limit exceeded -- dropping packet");
