  ...
  static TypeId tid = TypeId ("ns3::PacketSink")
    ...
    .AddAttribute ("Local",
     ...
     .AddAttribute ("FileSize",
			     ...
			     UintegerValue (1500),
			     MakeUintegerAccessor (&PacketSink::m_fileSize),
...
{
 // NS_LOG_FUNCTION (this);
 // NS_LOG_INFO("at: "<<Simulator::Now()<<" received: "<<m_totalRx);
  return m_totalRx;
}
...
{
  NS_LOG_INFO("Time done: "<< Simulator::Now().GetSeconds());
  //NS_LOG_FUNCTION (this);
