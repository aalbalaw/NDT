...
#ifndef CLIENT_CCTP_H
#define CLIENT_CCTP_H
 ...
 */
class ClientOverCCTP : public Application
{
public:
  /**
...
private:
   ...
   */
  void HandleResponse (Address from);

  void GetHostByName (std::string name );
  ...
  Address m_localDnsAddress; //!< Local DNS address
  bool m_dnsResolved;
  std::string m_url;
