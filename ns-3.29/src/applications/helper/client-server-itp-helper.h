 ...
 */
#ifndef CLIENT_SERVER_ITP_HELPER_H
#define CLIENT_SERVER_ITP_HELPER_H
 ...
 */
class ItpServerHelper
{
public:
  /**
   * Create ItpServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  ItpServerHelper (uint16_t port);
 ...
 */
class ItpClientHelper
{
public:
  /**
   * Create ItpClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   */
  ItpClientHelper (Address ip, uint16_t port);
  /**
   * Create ItpClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote request response server
   */
  ItpClientHelper (Ipv4Address ip, uint16_t port);
   ...
   */
  ItpClientHelper (Address localDnsaddress, uint16_t port, bool enableDNS);
