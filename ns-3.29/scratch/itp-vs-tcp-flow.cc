...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::producer::PayloadSize", UintegerValue (1200));
  Config::SetDefault ("ns3::ItpCache::PayloadSize", UintegerValue (1200));
 ...
 // Config::SetDefault ("ns3::TcpSocketBase::ReTxThreshold", UintegerValue (3));
  ...
  accessLink1.SetChannelAttribute ("Delay", StringValue ("33ms"));
  ...
  accessLink2.SetChannelAttribute ("Delay", StringValue ("33ms"));
