...
main (int argc, char *argv[])
{
 ...
 // Config::SetDefault ("ns3::TcpSocketBase::ReTxThreshold", UintegerValue (3));
  ...
  accessLink1.SetQueue ("ns3::DropTailQueue", "MaxSize", StringValue ("140000B"));
  ...
  endLink4.SetChannelAttribute ("Delay", ("Delay", StringValue ("2ms")));
  ...
  endLink5.SetChannelAttribute ("Delay", ("Delay", StringValue ("2ms")));
  ...
  endLink6.SetChannelAttribute ("Delay", ("Delay", StringValue ("2ms")));
...
//
  ...
  tch1.Uninstall(devicesAccessLink1);
...
////// Consumer 2///////////////////////
  uint16_t port2 = 90;  // well-known echo port number
